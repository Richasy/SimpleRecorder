...
namespace CaptureEncoder
{
    ...
    {
        public EncoderWithAudioFile(IDirect3DDevice device, GraphicsCaptureItem item)
        {
            _device = device;
            _captureItem = item;
            _isRecording = false;

            CreateMediaObjectsInternal();
        }
        ...
        private void CreateMediaObjectsInternal()
        {
        ...
        private AudioRecord _audioCapture;
